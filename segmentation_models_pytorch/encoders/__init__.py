...
from .timm_swin_transformer import timm_swin_transformer_encoders
from .timm_inceptionnext import timm_inceptionnextnext_encoders
from .timm_focalnet import timm_focalnet_encoders
from .nextvit import nextvit_encoders
...
encoders.update(timm_swin_transformer_encoders)
encoders.update(timm_inceptionnextnext_encoders)
encoders.update(timm_focalnet_encoders)
encoders.update(nextvit_encoders)


def get_encoder(name, in_channels=3, depth=5, weights=None, output_stride=32, encoder_args=None, **kwargs):
    ...
    if weights is not None:
        ...
        encoder.load_state_dict(model_zoo.load_url(settings["url"], map_location='cpu'))
